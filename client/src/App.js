...
class App extends Component {
  state = { storageValue: 0, web3: null, accounts: null, contract: null ,subEvent:null};
  ...
  runExample = async () => {
    ...
    this.setState({ storageValue: response, subEvent:result });
  };
  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <div>The subscribed Event listner {this.state.subEvent}</div>
