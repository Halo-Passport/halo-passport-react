...
contract TestingCenter{
    ...
    address public owner = 0x233021b201D7C9661f4F2D9383d05F5A1cF759D1;
...
//events
    ...
    event PatientTestResultsCompleted(address  _PatientSC, address  _EA,string _testResult);
    ...
    event PatientSpecimenReceived(address PatientSC, address EA,string info);
...
//     }
    ...
    function PublishTestResults( address patientSC, address myAddress,string memory testResult) OnlyOwner public  returns(bool sufficient) {
       emit PatientTestResultsCompleted( patientSC,  myAddress,testResult);
       return true;
    }
    ...
    function ReceivedSpecimen(address PatientSc, address EA)OnlyOwner public{
        emit PatientSpecimenReceived(PatientSc,EA,"Specimen Received");
    }
}